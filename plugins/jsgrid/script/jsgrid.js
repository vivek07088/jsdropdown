 ...
 */
 //customized for multi select row functionality (on 25-july-2017, by vivek)
...
(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        selecting: true,
        multiSelectedRowClass: "jsgrid-multi-selected-row",
            ...
            $result.addClass(this._getRowClasses(item, itemIndex))
                ...
                .on("click", $.proxy(function (e) {
                    ...
                    if (this.multiSelect && e.ctrlKey) {
                        if ($result.hasClass(this.multiSelectedRowClass)) {
                            $result.removeClass(this.multiSelectedRowClass);
                        }
                        else {
                            $result.addClass(this.multiSelectedRowClass);
                        }

                        $result.closest("table").find("tr." + this.multiSelectedRowClass).each(function (index, trItem) {
                            selectedItems.push({
                                itemIndex: index,
                                item: $(this).data(JSGRID_ROW_DATA_KEY)
                            });
                        })
                    } else {
                        if (this.multiSelect) {
                            $result.closest("table").find("tr." + this.multiSelectedRowClass).removeClass(this.multiSelectedRowClass);
                        }
                        selectedItems.push({
                            item: item,
                            itemIndex: itemIndex,
